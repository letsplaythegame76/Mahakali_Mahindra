class ShowroomDeskCRM {
    ...
    this.vehicleBrands = {
      car: [
        ...
        },
        {
          name: "Hyundai",
          logo: "fa-car",
          defaultModels: ["Creta", "i20", "Verna", "Venue", "Tucson"],
        },
        {
          name: "Toyota",
          logo: "fa-car",
        ...
        },
        {
          name: "Mahindra",
          logo: "fa-tractor",
          defaultModels: ["Scorpio", "XUV700", "Thar", "Bolero", "XUV300"],
        },
        {
          name: "Honda",
          logo: "fa-car",
          defaultModels: ["City", "Amaze", "WR-V", "Jazz"],
        },
        {
          name: "Tata",
          logo: "fa-car",
          defaultModels: ["Nexon", "Punch", "Tiago", "Altroz", "Harrier"],
        },
        {
          name: "Kia",
          logo: "fa-car",
          defaultModels: ["Seltos", "Sonet", "Carnival", "Carens"],
        },
        {
          name: "MG",
          logo: "fa-car",
          defaultModels: ["Hector", "Astor", "Gloster", "ZS EV"],
        },
        // NEW CAR BRANDS ADDED
        {
          name: "Ford",
          logo: "fa-car",
          defaultModels: ["Figo", "Aspire", "EcoSport", "Endeavour", "Mustang"],
        },
        {
          name: "Skoda",
          logo: "fa-car",
          defaultModels: ["Octavia", "Superb", "Kushaq", "Slavia", "Kodiaq"],
        },
        {
          name: "Nissan",
          logo: "fa-car",
          defaultModels: ["Magnite", "Kicks", "Sunny", "Terrano"],
        },
        {
          name: "Renault",
          logo: "fa-car",
          defaultModels: ["Kwid", "Triber", "Kiger", "Duster"],
        },
        {
          name: "Volkswagen",
          logo: "fa-car",
          defaultModels: ["Polo", "Vento", "Taigun", "Tiguan"],
        },
      ...
      bike: [
        ...
        },
        {
          name: "Bajaj",
          logo: "fa-motorcycle",
          defaultModels: ["Pulsar", "Platina", "CT 100", "Avenger", "Dominar"],
        },
        {
          name: "TVS",
          logo: "fa-motorcycle",
          defaultModels: ["Apache", "Jupiter", "Ntorq", "Sport", "Star City"],
        },
        {
          name: "Royal Enfield",
          logo: "fa-motorcycle",
        ...
        },
        {
          name: "Honda",
          logo: "fa-motorcycle",
          defaultModels: ["Activa", "Shine", "CB Hornet", "Livo", "Dio"],
        },
        {
          name: "Suzuki",
          logo: "fa-motorcycle",
          defaultModels: ["Access", "Gixxer", "Intruder", "Burgman"],
        },
        {
          name: "Yamaha",
          logo: "fa-motorcycle",
          defaultModels: ["Ray", "Fascino", "FZ", "R15"],
        },
        {
          name: "KTM",
          logo: "fa-motorcycle",
          defaultModels: ["Duke 200", "Duke 390", "RC 200", "RC 390"],
        },
        // NEW BIKE BRANDS ADDED
        {
          name: "Jawa",
          logo: "fa-motorcycle",
          defaultModels: ["Jawa 42", "Jawa Perak", "Jawa Standard"],
        },
        {
          name: "Harley Davidson",
          logo: "fa-motorcycle",
          defaultModels: ["Street 750", "Iron 883", "Fat Boy", "Sportster"],
        },
        {
          name: "CFMoto",
          logo: "fa-motorcycle",
          defaultModels: ["300NK", "650MT", "700CL-X"],
        },
        {
          name: "Triumph",
          logo: "fa-motorcycle",
          defaultModels: ["Street Triple", "Bonneville", "Tiger 800"],
        },
        {
          name: "BMW",
          logo: "fa-motorcycle",
          defaultModels: ["G 310 R", "G 310 GS", "S 1000 RR"],
        },
        {
          name: "Kawasaki",
          logo: "fa-motorcycle",
          defaultModels: ["Ninja 300", "Z900", "Versys 650"],
        },
        {
          name: "Benelli",
          logo: "fa-motorcycle",
          defaultModels: ["Imperiale 400", "TRK 502", "Leoncino 500"],
        },
        {
          name: "Aprilla",
          logo: "fa-motorcycle",
          defaultModels: ["RS 660", "Tuono 660", "SR 160"],
        },
        {
          name: "Chetak",
          logo: "fa-motorcycle",
          defaultModels: ["Chetak Classic", "Chetak Premium"],
        },
        {
          name: "Oben",
          logo: "fa-motorcycle",
          defaultModels: ["Oben Electric"],
        },
        {
          name: "OLA",
          logo: "fa-motorcycle",
          defaultModels: ["S1 Pro", "S1 Air"],
        },
        {
          name: "Other",
          logo: "fa-motorcycle",
      ...
      tractor: [
        ...
        },
        {
          name: "Swaraj",
          logo: "fa-tractor",
          defaultModels: ["735 FE", "855 FE", "744 XM", "717", "724"],
        },
        {
          name: "John Deere",
          logo: "fa-tractor",
          defaultModels: ["5050 D", "5310", "5405", "6125 B", "5036 D"],
        },
        {
          name: "New Holland",
          logo: "fa-tractor",
          defaultModels: ["3630 TX", "5620", "3600", "4710", "6450"],
        },
        {
          name: "Eicher",
          logo: "fa-tractor",
          defaultModels: ["380", "480", "548", "651", "242"],
        },
        {
          name: "Massey Ferguson",
          logo: "fa-tractor",
          defaultModels: ["1035", "241 DI", "6028", "7250"],
        },
        {
          name: "Kubota",
          logo: "fa-tractor",
          defaultModels: ["MU 4501", "MU 5501", "L Series"],
        },
        {
          name: "Sonalika",
          logo: "fa-tractor",
          defaultModels: ["GT 20", "DI 35", "Tiger", "Worldtrac"],
        },
        // NEW TRACTOR BRANDS ADDED
        {
          name: "Powertrac",
          logo: "fa-tractor",
          defaultModels: ["Euro 50", "439 Plus", "Euro 60"],
        },
        {
          name: "Farmtrac",
          logo: "fa-tractor",
          defaultModels: ["60 PowerMaxx", "45 Classic", "50 Powermaxx"],
        },
        {
          name: "Solis",
          logo: "fa-tractor",
          defaultModels: ["Solis 26", "Solis 50", "Solis 60"],
        },
        {
          name: "Force",
          logo: "fa-tractor",
          defaultModels: ["Force 5055", "Force 6065", "Force 7070"],
        },
        {
          name: "ACE",
          logo: "fa-tractor",
          defaultModels: ["ACE 60", "ACE 45", "ACE 50"],
        },
        {
          name: "VST",
          logo: "fa-tractor",
          defaultModels: ["VST 130", "VST 165", "VST 180"],
        },
        {
          name: "Trakstar",
          logo: "fa-tractor",
          defaultModels: ["Trakstar 45", "Trakstar 50", "Trakstar 60"],
        },
        {
          name: "Preet",
          logo: "fa-tractor",
          defaultModels: ["Preet 6049", "Preet 354", "Preet 245"],
        },
        {
          name: "Indo Farm",
          logo: "fa-tractor",
          defaultModels: ["Indo Farm 3035", "Indo Farm 4035", "Indo Farm 5035"],
        },
        {
          name: "Kartar",
          logo: "fa-tractor",
          defaultModels: ["Kartar 50", "Kartar 60", "Kartar 45"],
        },
        {
          name: "Escort",
          logo: "fa-tractor",
          defaultModels: ["Escort 380", "Escort 480", "Escort 580"],
        },
      ...
      threewheeler: [
        {
          name: "Bajaj",
          logo: "fa-truck",
          defaultModels: ["RE 4S", "RE Compact", "Maxima C", "Alox", "Qute"],
        },
        {
          name: "Mahindra",
          logo: "fa-truck",
          defaultModels: ["Alfa", "Treo", "Jeeto", "Zor Grand", "Imperio"],
        },
        {
          name: "Piaggio",
          logo: "fa-truck",
          defaultModels: ["Ape City", "Ape Xtra", "Ape E-City"],
        },
        { name: "TVS", logo: "fa-truck", defaultModels: ["King", "Vikram"] },
        {
          name: "Atul",
          logo: "fa-truck",
          defaultModels: ["Gem", "Shakti", "Riva"],
        },
        {
          name: "Force",
          logo: "fa-truck",
          defaultModels: ["Minidor", "Balwan"],
        },
        // NEW 3-WHEELER BRANDS ADDED
        {
          name: "Kinetic Green",
          logo: "fa-truck",
          defaultModels: ["Kinetic Safar", "Kinetic Zing"],
        },
  ...
  showEditEnquiryModal(enquiryId) {
    ...
    document.getElementById("edit-customer-name").textContent =
    ...
    // Set form values
    document.getElementById("edit-enquiry-model").value =
      enquiry.vehicleModel || "";
    document.getElementById("edit-exchange-model").value =
      enquiry.exchangeModel || "";
    ...
    // ========== NEW: Populate Sales Manager Dropdown ==========
    const select = document.getElementById("edit-sales-manager");
    if (select) {
      select.innerHTML = '<option value="">Select Sales Manager</option>';
      if (this.team && this.team.length > 0) {
        this.team.forEach((member) => {
          const option = document.createElement("option");
          option.value = member.uid; // Firebase UID
          option.textContent =
            member.name + " (" + (member.role || "sales") + ")";
          // Pre-select if this member is the current assigned manager
          if (member.uid === enquiry.salesManagerId) {
            option.selected = true;
          }
          select.appendChild(option);
        });
      } else {
        // If team is empty, show a disabled option
        const option = document.createElement("option");
        option.value = "";
  ...
  toggleEditExchangeFields(isExchange = null) {
    ...
    if (isExchange === null) {
      isExchange =
        document.getElementById("edit-exchange-yes")?.checked || false;
    }

    const regularFields = document.getElementById(
      "edit-regular-vehicle-fields",
    );
  ...
  loadEditInventoryModels() {
    ...
    modelSelect.innerHTML =
      '<option value="">Select a model from inventory</option>';
  ...
  openWhatsApp(enquiryId) {
    ...
    const vehicleModel =
      enquiry.vehicleModel ||
      (enquiry.isExchange ? enquiry.exchangeModel : "our vehicles");
...
📞 Call us: ${this.showroomData?.phone || ""}
📍 Visit: ${this.showroomData?.address || ""}
...
- Team ShowroomDesk`;
  ...
  async saveEditEnquiry() {
    ...
    if (status2.status === "grace") {
      this.showToast(
        `⚠️ Grace period active (${status.daysLeft} days left). Please upgrade to add new enquiries.`,
        "warning",
      );
      return;
    }
    ...
    if (isExchange) {
      const exchangeModel = document
        .getElementById("edit-exchange-model")
        .value.trim();
      if (!exchangeModel) {
      ...
      if (selectedModel && selectedModel !== "manual" && selectedModel !== "") {
        ...
        const selectedOption = Array.from(
          document.querySelectorAll("#edit-enquiry-model option"),
        ).find((opt) => opt.value === selectedModel);
    ...
    try {
      const enquiryRef = window.firebase.doc(
        window.firebase.db,
        "enquiries",
      ...
      if (isFollowupChanged && wasOldDateToday && oldFollowupDate) {
        console.log(
          "Tracking follow-up change - enquiry was scheduled for today and date changed",
        );
        ...
        console.log(
          "Follow-up changed but old date was NOT today - not tracking in Today's Hold",
        );
      }
  ...
  async trackFollowupChange(
    ...
    try {
      ...
      const holdRef = window.firebase.collection(
        window.firebase.db,
        "followupChanges",
      );
  ...
  showStatusUpdateModal(enquiryId) {
    ...
    if (enquiry.status === "booking") {
      const statusBookingAmountEl = document.getElementById(
        "status-booking-amount",
      );
      if (statusBookingAmountEl) {
        statusBookingAmountEl.value = enquiry.bookingAmount || "";
      }

      const statusBookingFieldsEl = document.getElementById(
  ...
  toggleStatusBookingFields() {
    ...
    if (status === "booking") {
      ...
      const bookingAmountInput = document.getElementById(
        "status-booking-amount",
      );
  ...
  updateSubscriptionDisplay() {
    ...
    if (planType === "trial") {
      ...
      if (daysLeft < 0) {
        ...
        if (expiryEl)
          expiryEl.textContent = `Expired on ${endDate.toLocaleDateString()}`;
        if (bannerUpgradeBtn) {
          bannerUpgradeBtn.innerHTML =
        ...
        if (expiryEl)
          expiryEl.textContent = `Expires on ${endDate.toLocaleDateString()}`;
        if (bannerUpgradeBtn) {
          bannerUpgradeBtn.innerHTML =
            '<i class="fas fa-rocket"></i> Upgrade Now';
        ...
        // Normal trial
        if (statusEl)
          statusEl.innerHTML = `<i class="fas fa-gift"></i> Trial Period - ${daysLeft} days left`;
        if (expiryEl)
          expiryEl.textContent = `Expires on ${endDate.toLocaleDateString()}`;
        if (bannerUpgradeBtn) {
          bannerUpgradeBtn.innerHTML =
      ...
      if (paymentStatus === "paid") {
        ...
        if (statusEl)
          statusEl.innerHTML = `<i class="fas fa-crown" style="color: gold;"></i> Active Plan - ₹${sub.price || 999}/month`;
        if (expiryEl)
          expiryEl.textContent = `Renews on ${endDate.toLocaleDateString()}`;
        ...
        if (statusEl)
          statusEl.innerHTML = `<i class="fas fa-clock" style="color: #f59e0b;"></i> Payment Pending - Plan Ready`;
        if (expiryEl)
          expiryEl.textContent = `Valid from ${new Date(sub.startDate).toLocaleDateString()}`;
        if (bannerUpgradeBtn) {
          bannerUpgradeBtn.innerHTML =
  ...
  isTrialFullyExpired() {
    ...
    const isTrial =
      subscription.planType === "trial" || subscription.status === "trial";
  ...
  getTrialStatus() {
    ...
    if (daysLeft > 0) {
      ...
      return {
        status: "grace",
        daysOverdue: daysAfterExpiry,
        daysLeft: 5 - daysAfterExpiry + 1,
      };
    } else {
  ...
  disableAllInteractions() {
    ...
    // Disable all buttons
    document
      .querySelectorAll("button, .nav-btn, .btn, .user-profile, .dropdown-item")
      .forEach((el) => {
    ...
    document
      .querySelectorAll(
        ".data-table tbody tr, .followup-item, .intervention-item, .day-header, .brand-header",
      )
      .forEach((el) => {
        el.style.pointerEvents = "none";
  ...
  enableGracePeriodChecks() {
    ...
    this.saveEnquiry = async function (e) {
      ...
      if (status.status === "grace") {
        self.showToast(
          `⚠️ Grace period active! Please upgrade to add new enquiries. ${status.daysLeft} days left before access is locked.`,
          "warning",
        );
        return;
      }
  ...
  disableAllInteractions() {
    ...
    document
      .querySelectorAll(
        ".data-table tbody tr, .followup-item, .intervention-item",
      )
      .forEach((el) => {
        el.style.pointerEvents = "none";
      });
  ...
  showTrialActive(daysLeft) {
    ...
    if (daysLeft <= 3) {
      this.showToast(
        `⚠️ Your trial ends in ${daysLeft} days! Upgrade to avoid interruption.`,
        "warning",
      );
    }
  }
  ...
  activateReadOnlyMode() {
    ...
    const addEnquiryBtn = document.querySelector(
      '.btn-primary[onclick*="add-enquiry"]',
    );
    if (addEnquiryBtn) {
    ...
    document
      .querySelectorAll(
        '.btn-info, .btn-edit, [onclick*="showEditEnquiryModal"]',
      )
      .forEach((btn) => {
    ...
    const addInventoryBtn = document.querySelector(
    ...
    document
      .querySelectorAll("#enquiry-status, .status-update")
      .forEach((select) => {
    ...
    if (dashboardHeader && !document.querySelector(".readonly-badge")) {
      ...
      badge.style.cssText =
        "background: #ea580c; color: white; padding: 0.25rem 0.75rem; border-radius: var(--radius-full); font-size: 0.75rem; margin-left: 1rem;";
      badge.innerHTML = '<i class="fas fa-eye"></i> Read-Only Mode';
      dashboardHeader.appendChild(badge);
    }

    this.showToast(
      "Your trial has ended. You are now in read-only mode. Upgrade to continue adding/editing.",
      "warning",
    );
  }
  ...
  activateFullBlocker() {
    ...
    document
      .querySelectorAll("button, input, select, textarea, .nav-btn")
      .forEach((el) => {
        el.disabled = true;
        el.style.pointerEvents = "none";
      });
  ...
  removeTrialRestrictions() {
    ...
    document
      .querySelectorAll(
        '.btn-info, .btn-edit, .btn-primary, [onclick*="showEditEnquiryModal"], [onclick*="showAddInventoryModal"], [onclick*="showAddTeamModal"]',
      )
      .forEach((btn) => {
        btn.disabled = false;
        btn.style.opacity = "";
  ...
  showTrialEndingWarning(daysLeft) {
    ...
    this.showToast(
      `⚠️ Your trial ends in ${daysLeft} days! Upgrade now to avoid interruption.`,
      "warning",
    );
  ...
  removeTrialBlocker() {
    ...
    const allButtons = document.querySelectorAll(
      ".nav-btn, .btn, .user-profile, .nav-btn, .dropdown-item, .btn-upgrade",
    );
    allButtons.forEach((btn) => {
    ...
    if (actualPlanType === "trial") {
      ...
      if (actualDaysLeft > 0) {
        ...
        upgradeBtn.innerHTML =
          '<i class="fas fa-crown"></i> Trial Expired - Upgrade Now';
      }
      upgradeBtn.onclick = () => this.showUpgradeModal();
      ...
      if (actualPaymentStatus === "paid") {
        ...
        if (actualDaysLeft <= 10) {
          ...
          upgradeBtn.innerHTML =
            '<i class="fas fa-crown" style="color: gold;"></i> Active Plan';
  ...
  showUpgradeModal() {
    ...
    if (modal) {
      ...
      const razorpayOption = document.querySelector(
        '.payment-method[data-method="razorpay"]',
      );
      if (razorpayOption) {
        document
      ...
      this.showToast(
        "Upgrade feature is being loaded. Please try again.",
        "error",
      );
    }
  }
  ...
  checkAndReapplyBlocker() {
    ...
    if (this.isTrialFullyExpired()) {
      ...
      this.showTrialExpiredBlockScreen();
      this.showToast(
        "Please complete the upgrade process to continue using ShowroomDesk.",
        "warning",
      );
    }
    this.isComingFromTrialBlock = false;
  ...
  showRenewModal() {
    ...
    if (
      confirm(
        "Your plan is expiring soon. Would you like to renew now for ₹10,999/year?",
      )
    ) {
  ...
  closeUpgradeModal() {
    ...
    const badge = document.querySelector(
      "#upgrade-modal .modal-header .trial-badge",
    );
    if (badge) badge.remove();
  ...
  selectUpgradePaymentMethod(method) {
    ...
    document.getElementById("upgrade-bank-details").style.display =
  ...
  async processUpgrade() {
    if (this.upgradePaymentMethod === "razorpay") {
      ...
      this.showToast(
        "Please complete bank transfer and email receipt to accounts@showroomdesk.com",
        "info",
      );
    ...
    try {
      const options = {
        ...
        handler: async (response) => {
          ...
          this.showToast(
            "Upgrade successful! Thank you for your payment.",
            "success",
          );
        ...
        modal: {
          ondismiss: () => {
            ...
            this.checkAndReapplyBlocker();
            this.showToast(
              "Payment cancelled. Please complete payment to continue using ShowroomDesk.",
              "warning",
            );
          },
        },
  ...
  filterEnquiries() {
    const searchTerm =
      document.getElementById("enquiry-search")?.value.toLowerCase() || "";
    ...
    this.filteredEnquiries = this.enquiries.filter((enquiry) => {
      ...
      const matchesSearch =
        ...
        (enquiry.vehicleModel &&
          enquiry.vehicleModel.toLowerCase().includes(searchTerm)) ||
        (enquiry.exchangeModel &&
          enquiry.exchangeModel.toLowerCase().includes(searchTerm));
      ...
      const matchesManager =
        salesManagerFilter === "" ||
        (this.userRole === "owner" &&
          enquiry.salesManagerName === salesManagerFilter);
      ...
      return (
        matchesSearch && matchesSource && matchesManager && matchesLeadType
      );
    });
  ...
  renderFilteredEnquiriesTable() {
    ...
    if (this.filteredEnquiries.length === 0) {
      tbody.innerHTML =
        '<tr><td colspan="10" class="text-center py-4">No enquiries match your filters</td></tr>';
      return;
    }
    ...
    this.filteredEnquiries.slice(0, 50).forEach((enquiry) => {
      ...
      const followupDate = enquiry.followupDate
      ...
      let bookingAmountDisplay = enquiry.bookingAmount
        ? `₹${enquiry.bookingAmount.toLocaleString()}`
        : "-";
      ...
      const isHotOrWarm =
        ...
        enquiry.autoLeadType === "hot" ||
        enquiry.autoLeadType === "warm";
  ...
  populateSalesManagerFilter() {
    ...
    const managers = [
      ...new Set(this.enquiries.map((e) => e.salesManagerName).filter(Boolean)),
    ];
  ...
  editRemarks(enquiryId) {
    ...
    document.getElementById("remarks-customer-name").textContent =
      enquiry.customerName || "Unknown";
  ...
  async saveRemarks() {
    ...
    try {
      ...
      try {
        ...
        this.showToast(
          "Remarks updated but history could not be saved. Please check permissions.",
          "warning",
        );
      }
  ...
  async showRemarksHistory(enquiryId) {
    ...
    document.getElementById("history-customer-name").textContent =
      enquiry.customerName || "Unknown";
    document.getElementById("history-current-remarks").textContent =
      enquiry.remarks || "No remarks";

    const historyList = document.getElementById("remarks-history-list");
    historyList.innerHTML =
      '<div class="text-center text-muted py-4"><i class="fas fa-spinner fa-spin"></i> Loading history...</div>';
  ...
  toggleExchangeFields() {
    const isExchange =
      document.querySelector('input[name="is-exchange"]:checked')?.value ===
      "yes";
    ...
    try {
      ...
      if (docSnap.exists()) {
        ...
        this.showroomData = {
          ...
          paymentStatus:
            userData.paymentStatus || showroomData.paymentStatus || "unpaid",
          subscriptionStartDate:
            userData.subscriptionStartDate ||
            showroomData.subscriptionStartDate,
          subscriptionEndDate:
            userData.subscriptionEndDate || showroomData.subscriptionEndDate,
          // Add the FULL subscription object with safe defaults
          subscription: userData.subscription ||
            showroomData.subscription || {
              status: "trial",
              planType: "trial",
      ...
      try {
        ...
        if (backup) {
          ...
          if (age < 3600000) {
            ...
            this.loadCRMData().catch((e) =>
              console.log("Could not load CRM data"),
            );
          }
        }
      } catch (backupError) {
  ...
  async loadEnquiries() {
    try {
      const enquiriesRef = window.firebase.collection(
        window.firebase.db,
        "enquiries",
      );

      // Always filter by showroomId
      let queryConstraints = [
        window.firebase.where("showroomId", "==", this.showroomData.id),
      ];

      // If the user is NOT an owner, filter by salesManagerId
      if (this.userRole !== "owner") {
        queryConstraints.push(
          window.firebase.where("salesManagerId", "==", this.currentUser.uid),
        );
      }
      ...
      const q = window.firebase.query(enquiriesRef, ...queryConstraints);
      ...
      const interventionsCount = this.enquiries.filter(
        (e) => e.intervention && !e.intervention.resolved,
      ).length;
      document.getElementById("interventions-badge").textContent =
        interventionsCount;
  ...
  updateDashboard() {
    ...
    const todayItems = this.enquiries
      .filter((e) => {
        if (!e.followupDate) return false;
        const followupDate = new Date(e.followupDate);
        const today = new Date();
    ...
    if (todayItems.length === 0) {
      todayFollowups.innerHTML =
        '<div class="text-center text-muted py-4">No follow-ups scheduled</div>';
    } else {
      let html = "";
    ...
    const pendingInterventions = document.getElementById(
      "pending-interventions",
    );
    const interventions = this.enquiries
      .filter((e) => e.intervention && !e.intervention.resolved)
      .slice(0, 5);

    if (interventions.length === 0) {
      pendingInterventions.innerHTML =
        '<div class="text-center text-muted py-4">No pending interventions</div>';
    } else {
      let html = "";
    ...
    const exchangeCount = this.enquiries.filter(
      (e) => e.isExchange === true,
    ).length;
  ...
  loadNext10Days() {
    ...
    const totalUpcoming = Object.values(dayWiseData).reduce(
      (sum, day) => sum + day.count,
      0,
    );
    const todayCount =
      dayWiseData[today.toISOString().split("T")[0]]?.count || 0;
    ...
    const activeCount = this.enquiries.filter(
      (e) => e.status !== "closed" && e.status !== "lost",
    ).length;
      ...
      if (isToday || dayData.count > 0) {
        setTimeout(() => {
          ...
          const header = document.querySelector(
            `#accordion-${accordionId} .day-header`,
          );
  ...
  renderDayTable(enquiries, daysDiff, isToday) {
    ...
    enquiries.forEach((enquiry) => {
      ...
      const vehicleDisplay = enquiry.isExchange
        ? `🔄 ${enquiry.exchangeModel || "Exchange"}`
  ...
  async quickCompleteFollowup(enquiryId) {
    ...
    if (confirm(`Mark follow-up for ${enquiry.customerName} as completed?`)) {
      try {
        ...
        this.showToast(
          `Follow-up marked for ${enquiry.customerName}`,
          "success",
        );
  ...
  renderNext10DaysTable(upcomingEnquiries) {
    ...
    if (upcomingEnquiries.length === 0) {
      tbody.innerHTML =
        '<td><td colspan="9" class="text-center py-4">No follow-ups scheduled in next 10 days</td></tr>';
      return;
    }
    ...
    upcomingEnquiries.forEach((enquiry) => {
      ...
      row.innerHTML = `
            <td><strong>${enquiry.customerName || "Unknown"}</strong>${enquiry.isExchange ? '<br><small class="text-muted">🔄 Exchange</small>' : ""}</td>
            <td>${enquiry.phone || "N/A"}</td>
  ...
  async quickUpdateFollowup(enquiryId, newDate) {
    ...
    try {
      ...
      this.showToast(
        `Follow-up date updated for ${enquiry.customerName}`,
        "success",
      );
  ...
  async quickUpdateStatus(enquiryId, newStatus) {
    ...
    try {
      ...
      if (newStatus === "booking") {
        const amount = prompt(
          `Enter booking amount for ${enquiry.customerName}:`,
          enquiry.bookingAmount || "",
        );
      ...
      this.showToast(
        `Status updated to ${newStatus} for ${enquiry.customerName}`,
        "success",
      );
  ...
  renderTodaySchedule() {
    ...
    if (todayItems.length === 0) {
      tbody.innerHTML =
        '<tr><td colspan="8" class="text-center py-4">No follow-ups today</td></tr>';
      return;
    }
    ...
    todayItems.forEach((enquiry) => {
      ...
      let modelDisplay = enquiry.isExchange
        ? enquiry.exchangeModel || ""
        : enquiry.vehicleModel || "";
  ...
  async loadTodayHold() {
    console.log(
      "Loading Today's Hold data for showroom:",
      this.showroomData.id,
    );
    ...
    try {
      ...
      try {
        ...
        const holdRef2 = window.firebase.collection(
          window.firebase.db,
          "followupChanges",
        );
  ...
  renderTodayHold() {
    console.log(
      "Rendering Today's Hold, changes count:",
      this.followupChanges.length,
    );
    ...
    if (this.followupChanges.length === 0) {
      tbody.innerHTML =
        '<tr><td colspan="9" class="text-center py-4">No follow-up changes to review</td></tr>';
      return;
    }

    const pendingChanges = this.followupChanges.filter(
      (c) => c.status === "pending",
    );

    if (pendingChanges.length === 0) {
      tbody.innerHTML =
        '<tr><td colspan="9" class="text-center py-4">No pending follow-up changes to review</td></tr>';
      return;
    }
    ...
    pendingChanges.forEach((change) => {
      ...
      const oldDateFormatted = change.oldFollowupDate
        ? new Date(change.oldFollowupDate).toLocaleString()
        : "Not set";
      const newDateFormatted = change.newFollowupDate
        ? new Date(change.newFollowupDate).toLocaleString()
        : "Not set";
  ...
  updateTodayHoldBadge() {
    ...
    if (badge) {
      badge.textContent = this.followupChanges.filter(
        (c) => c.status === "pending",
      ).length;
    }
  }
  ...
  async resolveHold(changeId, enquiryId) {
    if (
      !confirm(
        "Mark this follow-up change as reviewed? It will be removed from Today's Hold.",
      )
    )
      return;
    ...
    try {
      // Update in Firebase
      const holdRef = window.firebase.doc(
        window.firebase.db,
        "followupChanges",
        changeId,
      );
      ...
      // Update local data
      this.followupChanges = this.followupChanges.filter(
        (c) => c.id !== changeId,
      );
      this.renderTodayHold();
      this.updateTodayHoldBadge();
  ...
  renderInterventionsTable(interventions) {
    ...
    if (interventions.length === 0) {
      tbody.innerHTML =
        '<tr><td colspan="7" class="text-center py-4">No interventions found</td></tr>';
      return;
    }
    ...
    interventions.forEach((enquiry) => {
      ...
      if (enquiry.intervention?.assignedTo) {
        const assignedMember = this.team.find(
          (m) => m.uid === enquiry.intervention.assignedTo,
        );
  ...
  loadAnalytics() {
    ...
    document.getElementById("enquiries-by-status").innerHTML =
      statusHtml || '<div class="text-muted">No data</div>';
    ...
    document.getElementById("enquiries-by-vehicle").innerHTML =
      vehicleHtml || '<div class="text-muted">No data</div>';
  }
  ...
  loadPamphletsFromStorage() {
    try {
      ...
      console.log(
        `Loaded ${this.pamphlets.length} pamphlets from local storage`,
      );
  ...
  updatePamphletBadge() {
    ...
    const vehicleModels = new Set(
      this.pamphlets.map((p) => p.vehicleModel).filter(Boolean),
    );
  ...
  renderPamphletTable() {
    ...
    if (this.pamphlets.length === 0) {
      tbody.innerHTML =
        '<tr><td colspan="6" class="text-center py-4">No pamphlets uploaded yet. Click "Upload Pamphlet" to add your first one.</td></tr>';
      return;
    }

    this.pamphlets.forEach((pamphlet, index) => {
      const row = document.createElement("tr");
      const uploadDate = pamphlet.uploadedAt
        ? new Date(pamphlet.uploadedAt).toLocaleDateString()
        : "Recently";
      const fileSize = pamphlet.size
        ? (pamphlet.size / 1024).toFixed(1) + " KB"
        : "Unknown";
  ...
  async savePamphlet() {
    ...
    const vehicleModel = document.getElementById(
      "pamphlet-vehicle-model",
    ).value;
  ...
  showSendPamphletModal(enquiryId) {
    ...
    document.getElementById("send-customer-name").textContent =
      enquiry.customerName || "Unknown";
    document.getElementById("send-customer-phone").textContent =
      enquiry.phone || "N/A";
    document.getElementById("send-vehicle-model").textContent =
      enquiry.vehicleModel ||
      (enquiry.isExchange
        ? `Exchange: ${enquiry.exchangeModel}`
        : "Not specified");
    ...
    document.getElementById("send-message-preview").innerHTML =
      this.formatMessagePreview(defaultMessage);
  ...
  renderPamphletGrid(vehicleModel) {
    ...
    if (vehicleModel) {
      filteredPamphlets = this.pamphlets.filter(
        (p) =>
  ...
  selectPamphletForSend(index) {
    ...
    if (!currentMessage.includes(pamphlet.name)) {
      customMessage.value =
        currentMessage + `\n\n📸 Check out our ${pamphlet.name}!`;
      document.getElementById("send-message-preview").innerHTML =
        this.formatMessagePreview(customMessage.value);
    }
  }
...
- Team ShowroomDesk`;
  ...
  async sendPamphletViaWhatsApp() {
    ...
    const waLink = `https://wa.me/${cleanPhone}?text=${encodedMessage}%0A%0A📸 *Pamphlet:* ${imageUrl}`;
    ...
    this.showToast(
      "WhatsApp opened! Send the message from WhatsApp.",
      "success",
    );
  ...
  generateInterventionsReport() {
    return this.enquiries
      ...
      .map((e) => [
        ...
        e.intervention.assignedTo
          ? this.getSalesManagerName(e.intervention.assignedTo)
          : "Unassigned",
        e.intervention.deadline
          ? new Date(e.intervention.deadline).toLocaleDateString()
          : "Not set",
  ...
  async loadInventory(forceRefresh = false) {
    try {
      ...
      if (!forceRefresh && this.inventory && this.inventory.length > 0) {
        ...
        if (
          document.getElementById("add-enquiry").classList.contains("active")
        ) {
          this.loadInventoryModels();
        }
        return;
      ...
      if (tbody) {
        tbody.innerHTML =
          '<tr><td colspan="6" class="text-center py-4"><i class="fas fa-spinner fa-spin"></i> Loading inventory...</td></tr>';
      }

      // Create query with index hint for better performance
      const inventoryRef = window.firebase.collection(
        window.firebase.db,
        "inventory",
      );
      const q = window.firebase.query(
      ...
      try {
        localStorage.setItem(
          `inventory_${this.showroomData.id}`,
          JSON.stringify({
            data: this.inventory,
            timestamp: Date.now(),
          }),
      ...
      if (
        ...
        console.log(
          "First time user - inventory will be created when adding first model",
        );
        this.inventory = [];
        this.renderInventoryTable();
        return;
  ...
  renderInventoryTable() {
    ...
    if (!this.inventory || this.inventory.length === 0) {
      tbody.innerHTML =
        '<tr><td colspan="6" class="text-center py-4">No models added yet. Click "Add New Model" to add your first model.</td></tr>';
      return;
    }
  ...
  showAddTeamModal() {
    ...
    if (this.userRole !== "owner") {
      this.showToast(
        "You don't have permission to add team members. This feature is only available to the owner.",
        "error",
      );
      return;
    }
  ...
  async saveInventory() {
    ...
    if (!this.showroomData.vehicleTypes.includes(type)) {
      this.showToast(
        `Your showroom does not support ${type} vehicles`,
        "error",
      );
      return;
    }
    ...
    try {
      ...
      if (error.code === "permission-denied") {
        ...
        this.showToast(
          "Unable to save. Please check Firestore security rules.",
          "error",
        );
        ...
        this.closeInventoryModal();
        this.showToast(
          "Model added to local list (will not persist after reload)",
          "warning",
        );
      } else {
  ...
  async deleteInventory(id) {
    ...
    try {
      const inventoryRef = window.firebase.doc(
        window.firebase.db,
        "inventory",
        id,
      );
      ...
      if (error.code === "permission-denied") {
        this.showToast(
          "Permission denied. Only owners and managers can delete inventory.",
          "error",
        );
      } else {
  ...
  async loadTeam() {
    try {
      ...
      console.log("Team loaded:", this.team.length, "members");
      console.log(
        "Team members:",
        this.team.map((m) => ({ name: m.name, uid: m.uid, role: m.role })),
      );
  ...
  renderTeamTable() {
    ...
    if (this.team.length === 0) {
      tbody.innerHTML =
        '<tr><td colspan="8" class="text-center py-4">No team members added yet</td></tr>';
      return;
    }

    this.team.forEach((member) => {
      const memberEnquiries = this.enquiries.filter(
        (e) => e.salesManagerId === member.uid,
      );
      const closedDeals = memberEnquiries.filter(
        (e) => e.status === "closed",
      ).length;
      const bookings = memberEnquiries.filter(
        (e) => e.status === "booking",
      ).length;
  ...
  async saveTeamMember() {
    ...
    try {
      ...
      if (this.showroomData.subscriptionStartDate) {
        safeShowroomData.subscriptionStartDate =
          this.showroomData.subscriptionStartDate;
      }
      if (this.showroomData.subscriptionEndDate) {
        safeShowroomData.subscriptionEndDate =
          this.showroomData.subscriptionEndDate;
      }
      ...
      if (this.showroomData.subscription) {
        safeShowroomData.subscription = {
          ...
          paymentStatus:
            this.showroomData.subscription.paymentStatus || "unpaid",
          startDate:
            this.showroomData.subscription.startDate ||
            new Date().toISOString(),
          endDate:
            this.showroomData.subscription.endDate ||
      ...
      if (error.code === "auth/email-already-in-use") {
        ...
        this.showToast(
          "Error with showroom data. Please refresh and try again.",
          "error",
        );
  ...
  async deleteTeamMember(uid) {
    ...
    try {
      await window.firebase.deleteDoc(
        window.firebase.doc(window.firebase.db, "users", uid),
      );
      await this.loadTeam();
  ...
  async saveEnquiry(e) {
    ...
    if (status2.status === "grace") {
      this.showToast(
        `⚠️ Grace period active (${status2.daysLeft} days left). Please upgrade to add new enquiries.`,
        "warning",
      );
      return;
    }
    ...
    const status = document.getElementById("enquiry-status").value;
    const bookingAmount = document.getElementById(
      "enquiry-booking-amount",
    ).value;
    ...
    const enquiryData = {
      customerName: document
        .getElementById("enquiry-customer-name")
        .value.trim(),
    ...
    if (selectedModel && selectedModel !== "manual" && selectedModel !== "") {
      ...
      const selectedOption = Array.from(
        document.querySelectorAll("#enquiry-model option"),
      ).find((opt) => opt.value === selectedModel);
      if (selectedOption && selectedOption.dataset) {
      ...
      enquiryData.remarks =
        (enquiryData.remarks ? enquiryData.remarks + "\n" : "") +
        "Note: Customer interested in a model not in inventory - please specify details.";
    } else {
      this.showToast("Please select a vehicle model", "error");
      return;
    ...
    if (isExchange) {
      const exchangeModel = document
        .getElementById("enquiry-exchange-model")
        .value.trim();
      if (!exchangeModel) {
    ...
    try {
      ...
      document.querySelector('input[name="is-exchange"][value="no"]').checked =
        true;
      this.toggleExchangeFields();
      this.toggleBookingFields();
      await this.loadEnquiries();
    ...
    if (enquiry) {
      ...
      alert(
        "View enquiry details - " +
          ...
          (enquiry.isExchange
            ? "Exchange: " + enquiry.exchangeModel
            : "Vehicle: " + (enquiry.vehicleModel || "Not specified")) +
          "\n" +
          "Status: " +
          enquiry.status +
          "\n" +
          (enquiry.status === "booking" && enquiry.bookingAmount
            ? "Booking Amount: ₹" +
              enquiry.bookingAmount.toLocaleString() +
              "\n"
            : "") +
  ...
  async saveIntervention() {
    ...
    try {
      ...
      // Reassign ownership of the enquiry to the assignee so it shows up
      // in their (salesManagerId-filtered) Enquiries / Interventions views.
      const assignedMember = this.team.find((m) => m.uid === assignee);
      const updatePayload = {
        intervention: {
          priority,
          message,
      ...
      if (assignee) {
        updatePayload.salesManagerId = assignee;
        updatePayload.salesManagerName = assignedMember
          ? assignedMember.name
          : "";
      }

      await window.firebase.updateDoc(enquiryRef, updatePayload);
  ...
  goToStep(step) {
    if (step > this.registrationData.step) {
      if (step === 2) {
        ...
        const hasNonExchange = this.registrationData.vehicleTypes.some(
          (type) => type !== "exchange",
        );
        if (hasNonExchange && this.registrationData.brands.length === 0) {
          this.showToast(
            "Please select at least one brand for your vehicles",
            "error",
          );
          return;
        }
  ...
  toggleVehicleType(type) {
    ...
    if (this.registrationData.vehicleTypes.includes(type)) {
      this.registrationData.vehicleTypes =
        this.registrationData.vehicleTypes.filter((t) => t !== type);
      card.classList.remove("selected");
    } else {
    ...
    document.getElementById("continue-to-brands").disabled =
      this.registrationData.vehicleTypes.length === 0;
  }
  ...
  loadBrands() {
    ...
    this.registrationData.vehicleTypes.forEach((type) => {
      ...
      this.vehicleBrands[type].forEach((brand) => {
        ...
        const brandModels =
          this.registrationData.models[brand.name] || brand.defaultModels || [];
  ...
  toggleBrand(brandName) {
    if (this.registrationData.brands.includes(brandName)) {
      this.registrationData.brands = this.registrationData.brands.filter(
        (b) => b !== brandName,
      );
    } else {
      ...
      if (!this.registrationData.models[brandName]) {
        ...
        this.registrationData.models[brandName] = brand
          ? [...brand.defaultModels]
          : [];
      }
    }
  ...
  removeModel(brandName, modelName) {
    if (this.registrationData.models[brandName]) {
      this.registrationData.models[brandName] = this.registrationData.models[
        brandName
    ...
    try {
      ...
      const options = {
        ...
        handler: async (response) => {
          ...
          this.showToast(
            "Registration complete! Welcome to ShowroomDesk!",
            "success",
          );
        },
        prefill: {
        ...
        modal: {
          ondismiss: () => {
            document.getElementById("payment-modal").style.display = "none";
            this.showToast(
              "Payment cancelled. You can try again or choose free trial.",
              "info",
            );
          },
        },
      ...
      document.getElementById("payment-modal").style.display = "none";
      this.showToast(
        "Unable to process payment. Please try again or choose bank transfer.",
        "error",
      );
    }
  }
  ...
  async createUserAccount(paymentId = null) {
    ...
    try {
      ...
      this.registrationData.brands.forEach((brand) => {
        brandModels[brand] =
          this.registrationData.models[brand] ||
      ...
      try {
        ...
        console.log(
          "Inventory collection initialized with test document:",
          testDoc.id,
        );

        // Delete the test document (optional, but cleaner)
        await window.firebase.deleteDoc(
          window.firebase.doc(window.firebase.db, "inventory", testDoc.id),
        );
      ...
      if (isPaid) {
        this.showToast(
          "Payment successful! Your 1-year subscription is now active.",
          "success",
        );
      } else {
        this.showToast(
